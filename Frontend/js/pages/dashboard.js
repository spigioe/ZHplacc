...
import { openAddZhModal, openViewZhModal, deleteZh } from '../services/zarthelyiService.js';
import { openAddExamModal, openViewExamModal, deleteExam } from '../services/examService.js';
...
export async function renderDashboard(container) {
    ...
    container.innerHTML = `
        <div class="dashboard-view">
                ...
                <div class="columns is-multiline">
                    ...
                    <div class="column is-6">
                        ...
                        ${kozelgoEsemenyek.map(evt => {
                            ...
                            const examClass = evt.isExam ? 'is-exam' : 'is-zh';
                            
                            return `
                            <div class="box p-0 mb-3 dash-event-card ${examClass}">
                                <div class="p-3">
                                    <div class="is-flex is-justify-content-space-between is-align-items-start mb-2">
                                        <div>
                                            ...
                                            <p class="has-text-weight-bold mb-0 dash-event-title">${escapeHTML(evt.subjectName || evt.SubjectName)}</p>
                                ...
                                <div class="has-background-light px-3 py-2 is-flex is-justify-content-flex-end dash-event-footer">
                                    <button class="button is-small is-ghost has-text-info p-0 dash-btn-view dash-btn-no-decor" data-id="${evt.id || evt.Id}" data-type="${evt.isExam ? 'exam' : 'zh'}">
                                        <span class="icon is-small"><i class="fa-solid fa-eye"></i></span>
                                        <span>Részletek</span>
                                    </button>
                                    <button class="button is-small is-ghost has-text-danger p-0 dash-btn-delete dash-btn-no-decor" data-id="${evt.id || evt.Id}" data-type="${evt.isExam ? 'exam' : 'zh'}">
            ...
            <!-- JOBB OSZLOP: Statisztika & Teendők -->
            <div class="dash-right dash-sidebar">
                ...
                <div class="box p-4 mb-4 has-background-info-light dash-stat-box-flat">
                ...
                <div class="box p-4 mb-4 dash-stat-box-solid">
                ...
                <div class="box p-4 dash-stat-box-dashed">
